  ...
  return (
    <div className="h-full bg-primary/30 py-32 text-center xl:text-left">
      ...
      <motion.div
        ...
        animate="show"
        exit="hidden"
        className="xl:flex absolute bottom-0 -left-[370px] hidden"
      >
        <Avatar />
      </motion.div>
      <div className="container mx-auto h-full flex flex-col items-center xl:flex-row gap-x-6">
        <div className="flex-1 flex flex-col justify-center">
          <motion.h2
            ...
            className="h2"
          >
            Captaving <span className="text-accent">Stories</span> birth
          ...
          >
            5 years of experience in the field of UI/UX designing. I have worked
            with many startups, agencies and individual clients and helped them
            grow their business by crafting beautiful and engaging designs.
          </motion.p>
          <motion.div
